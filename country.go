...
// AsCountry takes string representation of ISO 3166-1 Alpha2 or Alpha3 country code and returns a Country.
func AsCountry(code string) (Country, error) {
	...
	case 3:
		m = alpha3ToCountry
	default:
		return 0, ErrUnsupportedCountryFormat
	}

	c, ok := m[strings.ToUpper(code)]
	if !ok {
		return 0, ErrUnknownCountryCode
	}
	return c, nil
}
...
var (
	ErrUnsupportedCountryFormat = errors.New("invalid string representation of the country")
